...
mv "./release/reddit-revanced-extended-v${APP_VERSION}.apk" "./release/reddit-revanced-extended-arsclib-v${APP_VERSION}.apk"
...
# Rename output
mv "./release/reddit-arm64-v8a-revanced-extended-v${APP_VERSION}.apk" "./release/reddit-arm64-v8a-revanced-extended-arsclib-v${APP_VERSION}.apk"
